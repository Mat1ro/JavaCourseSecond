public class Claw extends Hogwarts {
    public Claw(String fullName, int nobility, int honor, int courage, int diligence, int loyalty, int honesty, int intelligence, int wisdom, int wit, int creativity, int cunning, int determination, int ambition, int resourcefulness, int desireForPower) {
    ...
    public String toString() {
        return "Ученик Claw: " + super.toString();
    }

    public String whoIsBetter(Claw other) {
